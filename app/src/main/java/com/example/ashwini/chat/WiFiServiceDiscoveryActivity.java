...
import com.example.ashwini.chat.WiFiChatFragment.MessageTarget;
import com.example.ashwini.chat.WiFiDirectServicesList.DeviceClickListener;
import com.example.ashwini.chat.WiFiDirectServicesList.WiFiDevicesAdapter;
...
public class WiFiServiceDiscoveryActivity extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(WiFiServiceDiscoveryActivity.this, "Username: " + value, Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(this, SetUsername.class);
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case MESSAGE_READ:
                ...
                (chatFragment).pushMessage(" "+keyvalue+""+ readMessage);
                break;
            case MY_HANDLE:
                Object obj = msg.obj;
